...
//                 {" "}Nishad
//               </span>
//               <span className="ml-2 opacity-0 text-primary animate-fade-in-delay-2">
//                 {" "}Bhoyar
//               </span>
//             </h1>
...
//               Hi, I’m Nishad 👋  
//               I’m a passionate Full-Stack Developer who loves creating interactive and efficient web applications.  
//               With experience in React, Node.js, and modern web technologies, I enjoy turning ideas into real projects that solve problems.  
//               <br /><br />
//               I’m constantly learning new tools and frameworks to improve my skills, and I’m especially interested in exploring AI-powered applications and high-performance computing.  
//               <br /><br />
//               🚀 My goal is to build meaningful projects that make an impact and grow as a developer.  
//             </p>
...
//                                                     <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 blur-xl opacity-30 animate-pulse"></div>
//                                                     <img
//                                                     src="src/assets/IMG_E7340.JPG"
//                                                     alt="Nishad Bhoyar"
//                                                     className="relative object-cover w-full h-full transition-transform duration-500 border-4 border-purple-600 rounded-full shadow-xl hover:scale-105 hover:shadow-2xl"
//                                                     />
//                                                     </div>
//                                                     <div className="absolute inset-0 border-4 border-purple-600 rounded-full animate-pulse"></div>
